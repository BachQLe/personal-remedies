...
function Arrow() {
  return (
    <span className="mt-[7px] shrink-0 text-forest">
    ...
    <section id="providers" className="py-16 lg:py-24">
      <div className="mx-auto max-w-5xl container-px">
        ...
        <Stagger className="mt-14 grid gap-5 sm:gap-6 md:grid-cols-2">
          <StaggerItem>
            <article className="h-full rounded-3xl bg-sage-soft p-8 sm:p-10 border border-ink/[0.05] flex flex-col">
              <span className="tag">For Patients &amp; Caregivers</span>
              <h3 className="display mt-4 text-[26px] sm:text-[30px] leading-[1.15] font-medium">
                Take an active role in your health.
              </h3>
              <p className="mt-4 text-[15.5px] leading-[1.6] text-ink-soft max-w-[42ch]">
              ...
              <Link
                to="/survey"
                className="mt-auto pt-8 inline-flex items-center gap-1.5 text-[14.5px] font-medium text-amber border-b border-amber/40 self-start hover:border-amber transition"
              >
          ...
          <StaggerItem>
            <article className="h-full rounded-3xl bg-cream-warm p-8 sm:p-10 border border-ink/[0.05] flex flex-col">
              <span className="tag">For Providers &amp; Developers</span>
              <h3 className="display mt-4 text-[26px] sm:text-[30px] leading-[1.15] font-medium">
