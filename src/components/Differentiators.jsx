        ...
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          <Reveal delay={0.15}>
            <div ref={containerRef} className="relative select-none">
              ...
              {/* Garlic card */}
              <div className="rounded-2xl border border-ink/[0.08] bg-white p-5 shadow-card relative z-10">
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-[22px] leading-none">🧄</span>
                  <div>
                    <p className="font-semibold text-black text-[14.5px] leading-tight">Garlic</p>
                    <p className="text-[11px] text-black/40 leading-tight">Allium sativum</p>
                  </div>
                ...
                <div className="h-1.5 rounded-full bg-black/15 overflow-hidden mb-4">
                  <motion.div
                ...
                <div className="pt-3 border-t border-black/10">
                  <div className="flex items-center gap-1.5 mb-1.5">
                    ...
                    <p className="text-[9.5px] font-semibold tracking-widest uppercase text-black/35">Nutri reasoning</p>
                  </div>
                  ...
                  <div className="h-[88px] overflow-hidden">
                    <AnimatePresence mode="wait">
                      <motion.p
                        ...
                        className="text-[13px] leading-[1.65] text-black"
                      >
                        {rec.reason}
                      </motion.p>
                    </AnimatePresence>
              ...
              <div className="absolute inset-0 pointer-events-none" style={{
                ...
                <div className="absolute inset-0 rounded-3xl border-4 border-white/25" style={{
              ...
              <motion.div
                ...
                className="absolute top-0 left-0 pointer-events-none z-[100] inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-[12.5px] font-medium bg-sage-soft text-forest border border-forest/20 shadow-lift"
              >
                <span className="h-1.5 w-1.5 rounded-full bg-forest/50 flex-shrink-0" />
                {ghostLabel}
              </motion.div>
